...
* **Audio CDs**: VLC on PS2 Linux will play these, but if using digital audio (transmitted through USB) then the audio will lag/skip. Audio CDs can also be played and outputted through the Analog audio port and/or the headphone jack located on the USB optical drive. However, getting this working may require custom cables (such as [this one](../../../USB&#32;Devices/Optical&#32;Drives/cd_analog_audio_cable.jpg) hacked together by the author) and additional troubleshooting. These are not covered anywhere in this repository.
