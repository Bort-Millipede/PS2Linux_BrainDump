...
**Note:** Precompiled Binaries ([wxWindows-20031222.mipsEEel-linux.tar.gz](https://github.com/Bort-Millipede/PS2Linux_BrainDump/releases/download/initial/wxWindows-20031222.mipsEEel-linux.tar.gz)) are available in [Releases](https://github.com/Bort-Millipede/PS2Linux_BrainDump/releases)! Consult [Installing on PS2 Linux (as root)](#installing-on-ps2-linux-as-root) for installation instructions.

[Source link](http://download.videolan.org/pub/videolan/vlc/0.7.2/contrib/wxWindows-20031222.tar.gz) (available under LGPL v2.1)  
